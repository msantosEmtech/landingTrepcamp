   ...
   <div class="section pt-5" style="background-color: #FFF;">
       <div class="container pxDesk">
                       ...
                       <nav>
                           <ul class="nav nav-tabs" id="myTab" role="tablist" style="font-size: 1rem;">
                              <!--  <li class="nav-item" role="presentation">
                               ...
                               <li class="nav-item" role="presentation">
                                   <button class="nav-link" id="historic-tab" data-bs-toggle="tab" data-bs-target="#historic" type="button" role="tab" aria-controls="historic" aria-selected="false">1. Payment information</button>
                               </li>
                           </ul>
                       </nav>
                   </div>
           ...
           <div class="tab-content" id="myTabContent">
               ...
               <div class="tab-pane fade show row py-2 p-3 pb-4 profileCard" id="profile" role="tabpanel" aria-labelledby="profile-tab">
               ...
               <div class="tab-pane fade show active row py-2 p-3 pb-4  profileCard" id="historic" role="tabpanel" aria-labelledby="historic-tab">
                   <div class="" style="padding:1rem 0rem">
                       <div class="">
                           <div class="row">
                               <div class="col">
                           ...
                           <div class="row pt-3">
                               <form class="profileForm">
                                   ...
                                   <div class="row mb-3">
                                       <div class="col">
                                           <div id="card-number" style="border: 0.5px solid #D3CFCF; width: 100%; border-radius:25px; padding: 5px;"></div>                                           
                                       </div>
                                       <div id="secTok"></div>
                                       <input type="hidden" id="idChapterActive" value="<?= $idChapter ?>" />
                                   </div>
                                   <div class="row mb-3 justify-content-between" style="padding: 0 10px;">
                                       <div id="card-expiry" style="border: 0.5px solid #D3CFCF; width: 45%; border-radius:25px; padding: 6px 6px 6px 12px;"></div>
                                       <div id="card-cvc" style="border: 0.5px solid #D3CFCF; width: 45%; border-radius: 25px; padding: 6px 6px 6px 12px;"></div>
                                   </div>
                                    <!-- <div class="row mb-3">
                                        <div class="col">
                                            <button id="buttonPayStripe" style="background: #FFD041;border-radius: 25px;" class="btn btn-secondary btnSend">Pay</button>
                                        </div>
                                    </div>  -->                                   
                                                                       <!-- <div class="row mb-3">
                                        <div class="col">
       ...
       <div class="container pxDesk" style="padding:1rem 0rem">
           ...
           <div class="row">
               <div class="col-12" style="padding-right: 3rem;">
                   ...
                   <ul>
                       <li>
                           <p style="margin-bottom:0.3rem">Entrepreneurial Competencies Program</p>
                       </li>
                       <li>
                           <p>Entrepreneurial Methodologies Certificate</p>
                       </li>
                   </ul>
               </div>
           </div>
           ...
           <div class="row pt-3 justify-content-center">
                <button id="buttonPayStripe" style="background: #FFD041;border-radius: 25px;" class="btn btn-secondary btnAmarilloJoin">Pay Now</button>
           </div>
       </div>
   </div>