    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col-md-6 mb-5">
                <div>
                    <img class="mb-4" src="<?= base_url('assets/img/experience.svg') ?>">
                </div>
                <p class="pe-5">Win a one week all-paid experience at New York City to develop your entrepreneurial skills.</p>
                <div>
                    <button class="btn btn-primary btnAmarilloJoin">Join Now</button>
                </div>
            </div>
            <div class="col-md-6">
                <div class="row">
                    <img src="<?= base_url('assets/img/video-experiece.png') ?>" alt="" srcset="">
                </div>
            </div>
        </div>
    </div>
...
<section class="pt-5 pb-5" style="background-color:#F4F4F4;">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5 justify-content-center text-center px-3">
            ...
            <div class="col-md-7">
                <div class="row">
                    <img src="<?= base_url('assets/img/telescopio.png') ?>" alt="" srcset="">
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 text-center">
                <div class="mb-5">
                    <img src="<?= base_url('assets/img/TrepChallenge.png') ?>" alt="" srcset="">
                </div>
                <h2 class="mb-3">How may I join?</h2>
                <p>Celebrate with us our 10th year anniversary, by participating in the TrepChallenge Fun and immersive way of winning an all-paid experience.</p>
                <div class="px-3">
                    <div class="row" style="background-color: #6C20ED;border-radius: 8px;">
                        <h2 style="color: #FFF;" class="py-4">Are you up to the challenge?</h2>
            ...
            <div class="col-md-6">
                <h2 class="text-center mt-5">Review TrepChallenge Participation dynamics</h2>
                <div class="mt-5">
                        ...
                        <div class="accordion-item accordion-custom">
                            <h2 class="accordion-header item-custom" id="flush-headingOne">
                                <button class="accordion-button accordion-button-reto collapsed button-custom" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                                    <img class="me-3" src="<?= base_url('assets/img/participa.svg') ?>" alt="">1. Participate
                                </button>
                            </h2>
                        ...
                        <div class="accordion-item accordion-custom">
                            <h2 class="accordion-header item-custom" id="flush-headingTwo">
                                <button class="accordion-button accordion-button-reto collapsed button-custom" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo" aria-expanded="false" aria-controls="flush-collapseTwo">
                                    <img class="me-3" src="<?= base_url('assets/img/win.svg') ?>" alt="" srcset=""> 2. Win
                                </button>
                            </h2>
                            <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-12 holder-barra">
                                        <div class="accordion-body">
                                            <div class="row dot-titulo">
                                                <img style="width: 11%;" src="<?= base_url('assets/img/bullet.svg') ?>" alt=""><b style="width: 81%; font-size:20px;">Chapters:</b>
                                            </div>
                                            <p style="padding-left: 36px;">Every two weeks we'll open a new chapter to participate in our TrepChallenge. At the end of each chapter, we'll announce the winners.</p>
                                        </div>
                                        <div class="accordion-body">
                                            <div class="row dot-titulo">
                                                <img style="width: 11%;" src="<?= base_url('assets/img/bullet.svg') ?>" alt=""><b style="width: 81%; font-size:20px;">Prizes:</b>
                                            </div>
                                            <p style="padding-left: 36px;">Each chapter will have at least 2 winners, one for TikTok Viral Challenge and one for Competencies Challenge. Yet, there's more! Every 100 extra participants will unlock a new winner.*</p>
                                        </div>
                                        <div class="accordion-body">
                                            <div class="row dot-titulo">
                        ...
                        <div class="accordion-item accordion-custom">
                            <h2 class="accordion-header item-custom" id="flush-headingThree">
                                <button class="accordion-button accordion-button-reto collapsed button-custom" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree">
                                    <img class="me-3" src="<?= base_url('assets/img/plane.svg') ?>" alt="" srcset="">3. Experience
                                </button>
                            </h2>
