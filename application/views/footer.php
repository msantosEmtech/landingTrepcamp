    ...
    <div class="container">
        <div class="row py-2 pt-4 centerMobile">
            <div class="col-lg-6">
                ...
                <p class="text-muted pt-3 pb-3" style="color: #6A6A6A;">TrepCamp is an entrepreneurial academy focused
                    on transformation,
            ...
            <div class="col-lg-3 offset-lg-3 columna-info">
                <div class="container">
                    ...
                    <div class="row text-center">
                        <p><img src="<?=base_url('assets/img/telefono.svg') ?>" alt=""><a
                                style="color:#999;margin-left:7px">+521 5578325423</a></p>
                    </div>
                    <div class="row text-center">
                        <p><img src="<?=base_url('assets/img/correo.svg') ?>" alt=""><a
                                style="margin-left:7px">info@trepcamp.org</a></p>
                    </div>
                    <div class="row text-center mt-3">
                        <ul class="nav justify-content-center">
                            <li class="ms-4">
                                <a href="https://www.facebook.com/emtech.inst"><img
                                        src="<?=base_url('assets/img/tiktok.png') ?>"></a>
                            </li>
                            <li class="ms-4">
                                <a href="https://www.instagram.com/emtech.inst/"><img
                                        src="<?=base_url('assets/img/instagram.png') ?>"></a>
                            </li>
                        </ul>
                    </div>
                </div>
